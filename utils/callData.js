...
function thuDo(type, imgSrc_png) {
  if (type == "background") {
    document.querySelector(".background").style.backgroundImage = `url(${imgSrc_png})`;
  } else if (type == "topclothes") {
    document.querySelector(".bikinitop").style.zIndex = 3;
    document.querySelector(".bikinitop").innerHTML = `<img src="${imgSrc_png}" alt="${imgSrc_png}" class="w-100">`;
  } else if (type == "botclothes") {
    document.querySelector(".bikinibottom").style.zIndex = 2;
    document.querySelector(".bikinibottom").innerHTML = `<img src="${imgSrc_png}" alt="${imgSrc_png}" class="w-100">`;
  } else if (type == "shoes") {
    ...
    document.querySelector(".hairstyle").style.background = `url(${imgSrc_png})`;
  } else {
